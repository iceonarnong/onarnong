  ...
  if (kIsWeb) {
    await Firebase.initializeApp(
        options: FirebaseOptions(
            ...
            appId: "1:691283631304:web:02394f02756f29a919d9fd"));
  } else {
    await Firebase.initializeApp();
  }
...
//Class stateful เรียกใช้การท างานแบบโต้ตอบ
...
//ส่วนเขียน Code ภาษา dart เพื่อรับค่าจากหน้าจอมาค านวณหรือมาท าบางอย่างและส่งค่ากลับไป
//ส่วนการออกแบบหน้าจอ
  @override
  Widget build(BuildContext context) {
    return Scaffold(
